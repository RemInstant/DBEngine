#ifndef OPERATING_SYSTEMS_COURSE_WORK_LOGGER_BUILDER_H
#define OPERATING_SYSTEMS_COURSE_WORK_LOGGER_BUILDER_H
...
#endif //OPERATING_SYSTEMS_COURSE_WORK_LOGGER_BUILDER_H