#ifndef OPERATING_SYSTEMS_COURSE_WORK_LOGGER_GUARDANT_H
#define OPERATING_SYSTEMS_COURSE_WORK_LOGGER_GUARDANT_H
...
#endif //OPERATING_SYSTEMS_COURSE_WORK_LOGGER_GUARDANT_H