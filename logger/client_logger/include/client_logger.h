#ifndef OPERATING_SYSTEMS_COURSE_WORK_CLIENT_LOGGER_H
#define OPERATING_SYSTEMS_COURSE_WORK_CLIENT_LOGGER_H
...
#endif //OPERATING_SYSTEMS_COURSE_WORK_CLIENT_LOGGER_H