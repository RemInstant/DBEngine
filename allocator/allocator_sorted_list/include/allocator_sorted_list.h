#ifndef OPERATING_SYSTEMS_COURSE_WORK_ALLOCATOR_SORTED_LIST_H
#define OPERATING_SYSTEMS_COURSE_WORK_ALLOCATOR_SORTED_LIST_H
...
#endif //OPERATING_SYSTEMS_COURSE_WORK_ALLOCATOR_SORTED_LIST_H
